...
@section('contenido')
    <style>
        ...
        /* Opcional: agregar margen interno al contenedor principal */
        .contenido-wrapper {
            padding-left: 15px;
            padding-right: 15px;
        }
                ...
                @foreach($pacientes as $paciente)
                    <div class="col-lg-6 mb-4">
                        <div class="card h-100">
                            <div class="card-header  text-white" style="background-color: #0da592">
                                <h5 class="mb-0">
                                ...
                                @if($paciente->asignacionesHabitacion->isNotEmpty())
                                    ...
                                    <div class="alert alert-success mb-0">
                                        ...
                                        <p class="mb-0">
                                            ...
                                            <span class="badge bg-primary">{{ $asignacion->fecha_asignacion->startOfDay()->diffInDays(now()->startOfDay()) + 1 }} días</span>
                                        </p>
