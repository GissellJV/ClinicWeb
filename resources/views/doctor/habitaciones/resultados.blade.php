    ...
    @if($pacientes->isEmpty())
        <div class="card">
            <div class="card-body text-center py-5">
                ...
                <a href="{{ route('doctor.habitaciones.index') }}" class="btn btn-primary mt-3">
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            <div class="row mb-3">
                                ...
                                <div class="col-6">
                                    <p class="mb-0">
                                        <strong><i class="fas fa-birthday-cake"></i> Edad:</strong><br>
                            ...
                            @if($paciente->asignacionesHabitacion->isNotEmpty())
                                ...
                                <div class="alert alert-success mb-0">
                                    ...
                                    <p class="mb-1 mt-2">
                                        <strong><i class="far fa-calendar"></i> Ingreso:</strong>
