                ...
                <form method="post" action="{{route('pacientes.store')}}">
                    ...
                    <div data-mdb-input-init class="mb-3" >
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" id="telefono" name="telefono" class="form-control" data-mdb-input-mask-init data-mdb-input-mask="+48 999-999-999" value="{{old('telefono')}}" placeholder="00000000" />
                        </div>
                        @error('telefono')
                        <small class="text-danger">{{ $message }}</small>
                        @enderror
                    ...
                    <div class="text-center mt-3">
                        <p style="margin-bottom: 0.5rem; color: #666;">¿Tienes una cuenta?
                            <a style="color: #4ecdc4; text-decoration: none; font-weight: 500;" href="{{route('pacientes.login')}}">Iniciar Sesión</a>
                        </p>
                    </div>
                </form>
            </div>
